    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-[64px] font-bold mb-6 leading-tight">
                Stop <span className="bounce">Juggling</span> Tools, Start Growing Your Business with Nexus CRM: The All-in-One Solution That Saves You $1,500/Month
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-gray-600">
                Easy to use, packed with everything you need to manage and grow your business.
              </p>
              <div className="flex flex-col items-center lg:items-start gap-4">
                <Button 
                  className="bg-[#188bf6] text-white text-xl px-8 py-6 rounded-xl hover:bg-[#0070e0]"
                  onClick={() => window.open('https://shop.rivieregroup.org/checkout-page', '_blank')}
                >
                ...
                <div className="flex items-center gap-2 mt-4">
                  ...
                  <p className="text-sm text-gray-600">Rated 4.9/5 by 100+ businesses</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-[1280px] mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-6">Replace 14+ Tools with One Powerful Platform</h2>
          <p className="text-xl text-center text-gray-600 mb-12">Everything you need to run and grow your business, all in one place</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {features.map((feature, index) => (
              <div key={index} className="flex items-start gap-4 bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
                <div className="w-8 h-8 bg-[#188bf6] rounded-full flex items-center justify-center text-white">✓</div>
          ...
          <div className="mt-16 bg-white rounded-xl p-8 shadow-lg">
            <h3 className="text-2xl font-bold text-center mb-8">Save Big with Nexus CRM</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-6 border-2 border-red-200 rounded-xl">
                <h4 className="text-xl font-bold text-red-500 mb-4">Without Nexus</h4>
                <ul className="space-y-2">
                  ...
                  <li className="text-xl font-bold mt-4 pt-4 border-t">Total: $1,612/month</li>
                </ul>
              </div>
              <div className="p-6 border-2 border-green-200 rounded-xl bg-green-50">
                <h4 className="text-xl font-bold text-green-500 mb-4">With Nexus</h4>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                  ...
                  <li className="text-xl font-bold text-green-600 mt-4 pt-4 border-t">Only $97/month</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <p className="text-2xl text-gray-500 mb-4">Total value: <span className="line-through">$1612/Month</span></p>
            <p className="text-4xl font-bold text-[#188bf6] mb-8">Just $97/Month</p>
            <Button 
              className="bg-[#188bf6] text-white text-xl px-8 py-6 rounded-xl hover:bg-[#0070e0]"
              onClick={() => window.open('https://shop.rivieregroup.org/checkout-page', '_blank')}
            >
      ...
      <section className="py-24">
        <div className="max-w-[1280px] mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Trusted by Growing Businesses</h2>
          {/* Client Logos Card */}
          <div className="bg-slate-900 rounded-2xl p-8 shadow-lg mx-auto text-center mb-12">
            <h3 className="text-2xl font-bold mb-8 text-white">Our Current Clients:</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <h4 className="text-xl font-bold mb-3">"Our business works while we sleep!"</h4>
              <p className="text-base mb-3">
                "This software was a game changer. Instead of getting to the office and emailing leads, they're emailing me before I even get there."
              </p>
              <p className="text-sm font-semibold">-Nicole H., Medical Health Covers</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <h4 className="text-xl font-bold mb-3">"Saved us thousands each month!"</h4>
              <p className="text-base mb-3">
                "We were able to cancel 6 different subscriptions after switching to Nexus. The automation features alone have saved us countless hours."
              </p>
              <p className="text-sm font-semibold">-David R., Growth Marketing Agency</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-white mb-12 relative z-10">Who's This Perfect For?</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            {targetAudience.map((audience, index) => (
              <div key={index} className="bg-white/90 backdrop-blur-sm p-4 rounded-xl text-center shadow-md hover:shadow-lg transition-shadow relative z-10">
      ...
      <section className="py-24">
        <div className="max-w-[1280px] mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">Join 100+ businesses already saving time and money with Nexus CRM</p>
          <Button 
            className="bg-[#188bf6] text-white text-xl px-8 py-6 rounded-xl hover:bg-[#0070e0]"
            onClick={() => window.open('https://shop.rivieregroup.org/checkout-page', '_blank')}
          >
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-[1280px] mx-auto px-4 text-center">
          ...
          <h3 className="text-2xl text-gray-600 mb-8">Love it in 30 days or get your money back</h3>
          <div className="max-w-3xl mx-auto">
            <p className="text-lg mb-6">
              At Nexus CRM, we are committed to providing you with a seamless and effective CRM experience.
            </p>
            <p className="text-lg mb-6">
              We stand behind our platform and want you to feel confident in your investment.
            </p>
            <p className="text-lg mb-8">
              That's why we offer our Nexus Money-Back Guarantee to ensure your complete satisfaction.
            </p>
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h4 className="text-xl font-bold mb-4">Our Promise</h4>
              <p className="text-lg mb-6">
                If you are not completely satisfied with Nexus CRM within the first 14 days of your subscription,
      ...
      <footer className="flex flex-col w-full items-start gap-12 py-16 px-4 lg:px-8">
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-[169px] w-full">
          {/* Company Info Column */}
