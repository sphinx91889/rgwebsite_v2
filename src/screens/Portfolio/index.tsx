  ...
  const portfolioItems = [
    {
      ...
      description: "Our team contributed to the production of DJ Khaled's hit \"Welcome to My Hood\", featuring Rick Ross, Lil Wayne, Plies, and T-Pain. This RIAA GOLD certified track showcases our expertise in music production and engineering.",
    ...
    },
    {
      ...
      category: "Web Design",
      description: "BanVibeCoders.com is the underground movement for devs who build with soul—not by the book. A platform for overlooked creatives, vibe-heavy coders, and design-first dreamers who've been told they're 'doing too much'.",
      videoUrl: "https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/681d341fb78a40f4fa26f220.mov",
      ...
      mentor: {
        name: "Mev",
        title: "BVC Mentor",
        description: "Vibe coder with multiple contracted builds for Insurance, Healthcare, Medical Spa, Roofing, Music Rights, Reputation Management industries."
      }
    },
    {
      title: "FADE'EM UP",
      ...
      category: "Web Design",
      description: "Lehigh Acres' Premier Barbershop for Classic Cuts & Modern Styles.",
      videoUrl: "https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/681d30e3786bf149b4b4ea75.mp4",
      tags: ["Web Design", "UI/UX", "Development", "Branding"],
      type: "video",
      features: ["Home", "Services", "Barbers", "Gallery", "Testimonials", "Contact", "Book Now"],
    ...
    },
    {
      ...
      category: "Web Design",
      description: "Premier tattoo studio in Florida specializing in custom designs, black & grey realism, and color work that brings your ideas to life.",
      videoUrl: "https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/681d30e34b3e907ac068d36f.mp4",
      tags: ["Web Design", "UI/UX", "Development", "Branding"], 
    ...
    },
    {
      ...
      description: "Experience the unique sound and visual journey of Jayres. Blending artistry with innovative musicality to create an unforgettable experience.",
      videoUrl: "https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/681d30e36b471c45bf982ba9.mp4",
      tags: ["Web Design", "UI/UX", "Development", "Branding"], 
      ...
      <section className="pt-[235px] pb-24 px-4 md:px-8">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto font-['Poppins']">
            Showcasing our best work across music production, web development, and digital marketing
          </p>
        </div>
      </section>
                      ...
                      {item.mentor && (
                        <div className="bg-gray-100 p-4 rounded-lg mb-6">
                          <div className="flex items-center gap-4 mb-3">
                            <div className="text-lg font-semibold">{item.mentor.name}</div>
                            <div className="text-sm text-gray-600">{item.mentor.title}</div>
                          </div>
                          <p className="text-sm text-gray-600">{item.mentor.description}</p>
                        </div>
                      )}
                      {item.stats && (
                        <div className="grid grid-cols-3 gap-4 mb-6">
                          {Object.entries(item.stats).map(([key, value]) => (
                            <div key={key} className="text-center">
                              <div className="text-2xl font-bold text-[#188bf6]">{value}</div>
                        ...
                        <div className="w-full flex gap-4">
                          {item.type === 'youtube' ? (
                            <Button
                              ...
                              onClick={() => window.open(item.videoUrl.replace('embed/', 'watch?v='), '_blank')}
                            >
                              Watch Video
                            </Button>
                          ) : (
