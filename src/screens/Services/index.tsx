...
export const Services = (): JSX.Element => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Professional design services to enhance your brand's visual identity and marketing materials.",
      features: [
      ...
      image: "https://images.pexels.com/photos/196647/pexels-photo-196647.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    ...
    },
    {
      ...
      description: "Leverage the power of AI to automate processes and enhance customer experiences.",
      features: [
        "Chatbots",
        "Automation",
        "Data Analysis",
    ...
    },
    {
      ...
      description: "Professional audio services for music, podcasts, and other audio content.",
      features: [
        "Music Production",
        "Audio Engineering",
        "Mastering",
