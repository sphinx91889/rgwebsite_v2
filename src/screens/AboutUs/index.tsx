          ...
          <div className="flex flex-col items-center gap-16">            
            ...
            <div className="text-center max-w-[800px]">
              ...
              <p className="font-['Poppins'] text-xl md:text-2xl text-[#2f2f2f] leading-relaxed">
                RIVIERE GROUP® IS A FULL-SERVICE MEDIA PRODUCTION AND MARKETING AGENCY
                SPECIALIZING IN CUTTING-EDGE DIGITAL SOLUTIONS FOR BRANDS AND CREATIVES.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="text-center">
                    <h3 className="text-xl font-bold mb-2">🥇 RIAA Gold Certified</h3>
                    <p className="text-gray-600">Recognized for industry-leading music production and sound engineering.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex flex-col items-center gap-6">
                  ...
                  />
                  <div className="text-center">
                    <h3 className="text-xl font-bold mb-2">Award-Winning Graphic Design</h3>
                    <p className="text-gray-600">Creative recognized by design publications and peers.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex flex-col items-center gap-6">
                  ...
                  />
                  <div className="text-center">
                    <h3 className="text-xl font-bold mb-2">6× Billboard Top #1 Charted</h3>
                    <p className="text-gray-600">Trusted by artists and producers behind chart-topping hits.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
              <div className="bg-blue-50 p-8 rounded-2xl">
                <h2 className="font-['Montserrat'] font-bold text-xl mb-4">Digital Solutions</h2>
                <p className="font-['Poppins'] text-[#2f2f2f]">
                  WITH EXPERTISE IN WEB DESIGN & DEVELOPMENT, GRAPHIC DESIGN
                </p>
              </div>
              <div className="bg-purple-50 p-8 rounded-2xl">
                <h2 className="font-['Montserrat'] font-bold text-xl mb-4">Technology</h2>
                <p className="font-['Poppins'] text-[#2f2f2f]">
                  SEO, AUTOMATION, AI INTEGRATION
                </p>
              </div>
              <div className="bg-yellow-50 p-8 rounded-2xl">
                <h2 className="font-['Montserrat'] font-bold text-xl mb-4">Audio Production</h2>
                <p className="font-['Poppins'] text-[#2f2f2f]">
            ...
            <div className="text-center max-w-[800px] bg-gray-50 p-12 rounded-3xl">
              <p className="font-['Poppins'] text-xl text-[#2f2f2f] leading-relaxed mb-8">
                WE EMPOWER BUSINESSES AND ARTISTS TO BUILD THEIR PRESENCE AND MAXIMIZE THEIR IMPACT.
              </p>
              <p className="font-['Poppins'] text-xl text-[#2f2f2f] leading-relaxed">
                BACKED BY A TEAM OF INDUSTRY EXPERTS, WE CRAFT HIGH-PERFORMANCE DIGITAL EXPERIENCES 
                THAT DRIVE ENGAGEMENT, ELEVATE BRANDS, AND TURN CREATIVE VISIONS INTO REALITY.
              </p>
            </div>
