  ...
  const products = [
    {
      ...
      description: "A powerful all-in-one customer relationship management platform designed to help businesses streamline processes, improve customer retention, and drive sales growth.",
      features: [
      ...
      image: "https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/681ceb898c83422a29b1d113.png",
      bgColor: "bg-blue-50",
    ...
    },
    {
      ...
      description: "Our smart review management system helps businesses improve their online reputation by directing satisfied customers to leave public reviews while channeling negative feedback privately.",
      features: [
      ...
      image: "https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/681ce8653d8df880f9062ba0.jpeg",
    ...
    },
    {
      ...
      description: "A revolutionary platform for creative developers, designers, and coders who build with soul—not by the book. Join our community of overlooked creatives and design-first dreamers.",
      features: [
      ...
      image: "https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/680266c6235a270efe3ad644.png",
    ...
    },
    {
      ...
      description: "Create professional split sheets for your music collaborations. Track ownership, manage rights, and get signatures - all in one secure platform designed for modern creators.",
      features: [
      ...
      image: "https://assets.cdn.filesafe.space/8ngdMjJjmckUW3DffAfv/media/67ef0b0a585902a0af80fc97.png",
      bgColor: "bg-green-50",
      ...
      <section className="pt-[235px] pb-24 px-4 md:px-8">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto font-['Poppins']">
            Innovative platforms designed to help businesses and creators thrive in the digital age.
            From customer management to creative collaboration, we've got you covered.
          </p>
        </div>
      </section>
                ...
                <div className="flex flex-col lg:flex-row">
                  <div className="lg:w-1/3 h-[200px] lg:h-auto">
                    <img 
                      src={product.image}
                      alt={product.name}
                      className={`w-full h-full ${product.name === "BanVibeCoders" ? "object-contain mt-[26px]" : "object-cover"}`}
                    />
                  </div>
                  <div className="p-8 lg:w-2/3">
                    ...
                    <Button 
                      ...
                      onClick={() => window.open(product.name === "Nexus CRM" ? "https://shop.rivieregroup.org/nexus599364" : product.ctaLink, '_blank')}
                    >
                      Learn More
                    </Button>
                  </div>
